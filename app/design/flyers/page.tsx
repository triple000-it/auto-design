...
import { ArrowRight, CheckCircle, Palette, FileText, Printer, Users, Target } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Professionele Flyers
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Effectieve flyers die uw boodschap overbrengen en uw doelgroep bereiken. Van promotionele campagnes tot informatieve folders.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Wij bieden een complete range aan flyer oplossingen voor elke marketing behoefte!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              Aandacht trekkende flyers voor bijeenkomsten en evenementen.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Professionele flyers voor het delen van informatie, diensten en bedrijfsdetails.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
              Aantrekkelijke flyers bijvoorbeeld voor speciale aanbiedingen en/of kortingen.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Waarom kiezen voor onze flyers?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Flyers die uw specifieke doelgroep aanspreken
              </p>
            </div>
