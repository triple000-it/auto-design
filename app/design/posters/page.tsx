...
import { ArrowRight, CheckCircle, Palette, Image, Users, Calendar, MapPin } from 'lucide-react'
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Professionele Posters
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
              Opvallende posters die aandacht trekken en uw boodschap overbrengen. Van evenementen tot promotionele campagnes.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Wij bieden verschillende poster formaten en stijlen voor iedere behoefte en doelgroep!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Aandacht trekkende posters voor bijeenkomsten en evenementen.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Informatie</h3>
              <p className="text-gray-600 mb-6">
                Professionele posters voor het delen van informatie, diensten en bedrijfsdetails.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Promotie</h3>
              <p className="text-gray-600 mb-6">
                Krachtige posters voor product promoties, aanbiedingen en marketing campagnes.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Waarom kiezen voor onze posters?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Posters die uw specifieke doelgroep aanspreken
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                A0, A1, A2, A3 en custom formaten beschikbaar
              </p>
            </div>
          </div>
        </div>
