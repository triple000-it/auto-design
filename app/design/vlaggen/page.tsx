...
import { ArrowRight, CheckCircle, Palette, Flag, Building, Wind, Award } from 'lucide-react'

export default function VlaggenPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              Professionele Vlaggen
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Van bedrijfsvlaggen tot grote vlaggen voor evenementen - wij leveren duurzaamheid en kwaliteit.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Wij bieden diverse formaten, materialen en soorten vlaggen!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Bedrijven</h3>
              <p className="text-gray-600 mb-6">
                Professionele vlaggen met uw bedrijfslogo voor kantoren, gebouwen en terreinen.
              </p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Opvallende vlaggen voor evenementen, festivals en bijeenkomsten.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 mb-6">
                Aandacht trekkende vlaggen voor promotionele campagnes en marketing.
              </p>
              <ul className="space-y-2">
                <li className="flex items-center text-sm text-gray-600">
                  <CheckCircle className="w-4 h-4 text-green-500 mr-2" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Waarom kiezen voor onze vlaggen?
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Premium afwerking en materialen
              </p>
            </div>
